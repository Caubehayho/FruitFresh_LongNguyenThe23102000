                    ...
                    <div id="contact-page" class="container">
                        <div class="bg">
                            <div class="row">    
                                ...
                                <div class="col-sm-12">    			   			
                                    <h2 class="title text-center"><strong>Cảm ơn</strong></h2>    			    				    				
                                    <div id="gmap" class="contact-map" style="margin-bottom: 0; height: 100px; text-align: center; font-size: 18px">
                                        <span>Thanh toán thành công</span>
                                        <br>
                                        <span>Cảm ơn quý khách đã đặt hàng và thanh toán trực tuyến tại shop!</span>
                                    </div>
                                </div>			 		
                            </div>    	
                            <div class="row">  	
