...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- font-awesome icons -->
    <link rel="stylesheet" href="{{ asset('Back_End/css/font.css') }}" type="text/css" />
    <link href="{{ asset('Back_End/css/font-awesome.css') }}" rel="stylesheet">
    <!-- //font-awesome icons -->
    <scr pt src="{{asset('Back_End/js/jquery2.0.3.min.js')}}"></script>
</head>
...
<body>
    ...
    <script src="{{ asset('Back_End/js/jquery.dcjqaccordion.2.7.js') }}"></script>
    <script src="{{ asset('Back_End/js/scripts.js') }}"></script>
    <script src="{{ asset('Back_End/js/jquery.slimscroll.js') }}"></script>
    <script src="{{ asset('Back_End/js/jquery.nicescroll.js') }}"></script>
    {{-- <!--[if lte IE 8]><script language="javascript" type="text/javascript" src="{{asset('Back_End/js/flot-chart/excanvas.min.js"></script><![endif]--> --}}
    <script src="{{ asset('Back_End/js/jquery.scrollTo.js') }}"></script>
</body>
