...
@section('Admin.Dashboard')
    ...
    <div class="card">
        ...
        <div class="card-header border-0">
            <h3 class="mb-0">Tất cả thương hiệu</h3>
        </div>
            ...
            <table class="table align-items-center table-flush">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th scope="col" class="sort" data-sort="budget">Tên thương hiệu</th>
                        <th scope="col" class="sort" data-sort="status">Mô tả</th>
                        <th scope="col" class="sort" data-sort="status">Trạng thái thương hiệu</th>
                        ...
                        <tr>
                            <th scope="row">
                                <div class="media align-items-center">
                                    <div class="media-body">
                                        <span class="name mb-0 text-sm">{{ $Data->brand_id }}</span>
                                    </div>
                                </div>
                            </th>
                            <td class="budget">
                            ...
                            <td>
                                <span class="badge badge-dot mr-4">
                                    ...
                                    <span class="status">{{ $Data->brand_desc }}</span>
                                </span>
                            </td>
                            <td>
                                <div class="avatar-group">
                                    ...
                                    if ($Data->brand_status == 0) {
                                        ?>
                                    <a href={{ URL::to('hide-brand-fruit/' . $Data->brand_id) }}><i
                                            class='fa-solid fa-toggle-off'></i>&nbsp;Danh mục đã bị ẩn</a>
                                    <?php
                                        } else {
                                        ?>
                                    <a href={{ URL::to('show-brand-fruit/' . $Data->brand_id) }}><i
                            ...
                            <td class="">
                                <div class="dropdown">
                                    <a href="{{ URL::to('edit-brand-product/' . $Data->brand_id) }}"> <button
                                            class="btn btn-success">Sửa</button>
                                    </a>
                                    <a href="{{ URL::to('delete-brand-product/'.$Data->brand_id) }}"> <button
