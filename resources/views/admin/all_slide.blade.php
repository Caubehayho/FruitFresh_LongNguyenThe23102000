...
@section('Admin.Dashboard')
    ...
    <div class="card">
        ...
        <div class="card-header border-0">
            <h3 class="mb-0">Danh sách slide</h3>
        </div>
            ...
            <table class="table align-items-center table-flush">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th scope="col" class="sort" data-sort="budget">Tiêu đề</th>
                        <th scope="col" class="sort" data-sort="status">Hình ảnh slide</th>
                ...
                <tbody class="list">
                    @foreach ($ListDataSlide as $DataSlide)
                        <tr>
                            ...
                            <td class="budget">
                                {{ $DataSlide->slide_name }}
                            </td>
                            <td>
                                <img src="Up_Load/Slide/{{ $DataSlide->slide_image }}" height="150" width="150">
                            </td>
                            <td class="budget">
                                {{ $DataSlide->slide_desc }}
                            </td>
                            <td class="budget">
                                {{ $DataSlide->slide_content }}
                            </td>
                            <td>
                                <div class="avatar-group">
                                    <?php
                                    if ($DataSlide->slide_status == 0) {
                                        ?>
                                    <a href={{ URL::to('hide-slide/' . $DataSlide->slide_id) }}><i
                                            class='fa-solid fa-toggle-off'></i>&nbsp;Slide đã bị ẩn</a>
                                    <?php
                                        } else {
                                        ?>
                                    <a href={{ URL::to('show-slide/' . $DataSlide->slide_id) }}><i
                                            class='fa-solid fa-toggle-on'></i>&nbsp;Slide đang hiển thị</a>
                                    <?php
                                    }
                                    ?>
                                </div>
                            ...
                            <td class="">
                                <div class="dropdown">
                                    <a href="{{ URL::to('edit-slide/' . $DataSlide->slide_id) }}"> <button
                                            class="btn btn-success">Sửa</button>
                                    </a>
                                    <a href="{{ URL::to('delete-slide/'.$DataSlide->slide_id) }}"> <button
